...
public class Node {
    ...
    /**
     * Get a list of peer nodes that are members of a specific network
     *
     * @param nwid 64-bit network ID
     * @return List of network member peers or NULL on failure
     */
    public Peer[] networkPeers(long nwid) {
        return networkPeers(nodeId, nwid);
    }
    ...
    private native Peer[] networkPeers(long nodeId, long nwid);
